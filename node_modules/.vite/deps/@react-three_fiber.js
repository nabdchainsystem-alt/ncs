import {
  ...
  useStore,
  useThree
} from "./chunk-FCU7SZUJ.js";
import "./chunk-MSR42B2P.js";
import "./chunk-7DVTFXFI.js";
import {
  require_jsx_runtime
} from "./chunk-E46XU3GV.js";
import "./chunk-PK4DMDZI.js";
import {
  require_react
} from "./chunk-76R27W4D.js";
import "./chunk-UFVLOUL2.js";
import {
  __commonJS,
  __toESM
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef3 = React3.useRef, useEffect3 = React3.useEffect, useMemo3 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
var require_react_reconciler_development = __commonJS({
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    module.exports = function($$$config) {
      ...
      var REACT_MEMO_CACHE_SENTINEL = Symbol.for("react.memo_cache_sentinel"), MAYBE_ITERATOR_SYMBOL = Symbol.iterator, REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), ReactSharedInternals = React3.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd;
      ...
      exports2.discreteUpdates = function(fn, a2, b, c, d) {
        var prevTransition = ReactSharedInternals.T, previousPriority = getCurrentUpdatePriority();
        try {
          return setCurrentUpdatePriority(2), ReactSharedInternals.T = null, fn(a2, b, c, d);
        } finally {
      ...
      exports2.findBoundingRects = function(hostRoot, selectors) {
        ...
        for (selectors = hostRoot.length - 1; 0 < selectors; selectors--) {
          ...
          for (var targetLeft = i.x, targetRight = targetLeft + i.width, targetTop = i.y, targetBottom = targetTop + i.height, j2 = selectors - 1; 0 <= j2; j2--)
            if (selectors !== j2) {
...
function g(n, t) {
  let o2;
  return (...i) => {
    window.clearTimeout(o2), o2 = window.setTimeout(() => n(...i), t);
  };
}
function j({ debounce: n, scroll: t, polyfill: o2, offsetSize: i } = { debounce: 0, scroll: false, offsetSize: false }) {
  ...
  const [c, h] = (0, import_react.useState)({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }), e = (0, import_react.useRef)({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: c, orientationHandler: null }), d = n ? typeof n == "number" ? n : n.scroll : null, f2 = n ? typeof n == "number" ? n : n.resize : null, w = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => (w.current = true, () => void (w.current = false)));
  const [z, m2, s] = (0, import_react.useMemo)(() => {
    const r = () => {
      if (!e.current.element) return;
      const { left: y, top: C, width: H, height: O, bottom: S, right: x, x: B, y: R } = e.current.element.getBoundingClientRect(), l2 = { left: y, top: C, width: H, height: O, bottom: S, right: x, x: B, y: R };
      e.current.element instanceof HTMLElement && i && (l2.height = e.current.element.offsetHeight, l2.width = e.current.element.offsetWidth), Object.freeze(l2), w.current && !D(e.current.lastBounds, l2) && h(e.current.lastBounds = l2);
    };
  ...
  return X(s, !!t), W(m2), (0, import_react.useEffect)(() => {
    v(), b();
  }, [t, s, m2]), (0, import_react.useEffect)(() => v, []), [L, c, z];
}
function W(n) {
...
function E(n) {
  ...
  return [o2, i, a2].some((c) => c === "auto" || c === "scroll") && t.push(n), [...t, ...E(n.parentElement)];
}
...
var p2 = Symbol.for("react.context");
