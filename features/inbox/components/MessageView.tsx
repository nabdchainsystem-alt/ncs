                ...
                <div className="col-span-1 md:col-span-2 border border-gray-200 rounded-lg p-4 bg-white/50">
                    ...
                    {isAddingReminder && (
                        <div className="space-y-2 mb-3">
                            <input
                                className="w-full border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-100 focus:border-clickup-purple"
                                placeholder="Headline"
                                value={reminderTitle}
                                onChange={(e) => setReminderTitle(e.target.value)}
                            />
                            <textarea
                                className="w-full border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-100 focus:border-clickup-purple resize-none"
                            ...
                            <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                    className="text-xs bg-clickup-purple text-white px-3 py-1 rounded hover:brightness-110 disabled:opacity-50"
                                            ...
                                            <div key={task.id} className="border border-gray-200 rounded p-2 bg-white shadow-sm">
                                                ...
                                                <div className="mt-2">
                                                    <select
                                                        ...
                                                        className="w-full text-[11px] border border-gray-200 rounded px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-purple-100 focus:border-clickup-purple"
                                                    >
