...
import { Status, STATUS_COLORS } from '../../types/shared';
import {
    format,
    startOfMonth,
    endOfMonth,
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col gap-1 overflow-y-auto custom-scrollbar">
                                    {dayTasks.map(task => (
                                        <div
                                            key={task.id}
                                            className="px-2 py-1 rounded text-xs font-medium truncate border-l-2 shadow-sm cursor-pointer hover:opacity-80 transition-opacity bg-white border-gray-200"
