...
const OverviewPage: React.FC = () => {
    return (
        <div className="flex-1 flex items-center justify-center text-gray-400 flex-col animate-in fade-in duration-500 bg-gray-50/50">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Overview Dashboard</h3>
            <p className="text-gray-500 max-w-md text-center">Track high-level metrics and project health here. This module is currently being built.</p>
        </div>
    );
};
